...
<div id="left">
    ...
    <ul id="menu" class="bg-blue dker">
        <li>
            <a href="<?php echo base_url(); ?>doktor/dashboard">
        ...
        <li>
            <a href="<?php echo base_url(); ?>doktor/pesakitBaharu">
                <i class="fa fa-plus"></i>
                <span class="link-title">&nbsp;Pesakit Baharu</span>
            </a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>doktor/kosRawatan">
                <i class="fa fa-dollar-sign"></i>
                <span class="link-title">&nbsp;Kos Rawatan</span>
            </a>
        </li>
        <!-- <li>
            <a href="javascript:;">
