...
<head>
    <meta charset="UTF-8">
    <title>Pesakit | Paparan Kos Rawatan Pesakit @ <?php echo $app_title; ?></title>
...
z-index: 999999">
    ...
    <div class="bg-dark" id="wrap">
        ...
        <?php $this->load->view('module_pesakit/nav'); ?>
                        ...
                        <div class="float-right">
                            <ol class="breadcrumb nav_breadcrumb_top_align">
                                <li class="breadcrumb-item">
                                    <a href="<?php echo base_url(); ?>pesakit/paparanKosRawatan">
                                        <i class="fa fa-dollar-sign" data-pack="default" data-tags=""></i>
                                        Paparan Kos Rawatan
                                    </a>
                                </li>
                                <!-- <li class="breadcrumb-item">
