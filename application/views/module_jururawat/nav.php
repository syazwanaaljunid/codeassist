<div id="top">
    ...
    <nav class="navbar navbar-static-top">
        <div class="container-fluid m-0">
            <a class="navbar-brand float-left text-center" href="<?php echo base_url(); ?>doktor">
                <h4 class="text-white"><img src="<?php echo base_url(); ?>plugins/img/logow.png" class="admin_img" alt="logo"> <?php echo $app_title; ?></h4>
            </a>
            <div class="menu">
                        ...
                        <div class="dropdown-menu drop_box_align" role="menu" id="messages_dropdown">
                            ...
                            <div id="messages">
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/5.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                ...
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/8.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                ...
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/7.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                ...
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/6.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                        <div class="col-10 message-data">
                                            <strong>David</strong>
                        ...
                        <div class="dropdown-menu drop_box_align" role="menu">
                            ...
                            <div id="notifications">
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/1.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                        <div class="col-10 message-data">
                                ...
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/2.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                        <div class="col-10 message-data">
                                            <i class="fa fa-clock-o"></i>
                                            <strong>clay</strong>
                                ...
                                <div class="data">
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?php echo base_url(); ?>plugins/img/mailbox_imgs/3.jpg" class="message-img avatar rounded-circle"
                                                 alt="avatar1"></div>
                                        <div class="col-10 message-data">
                                            <i class="fa fa-clock-o"></i>
                                            <strong>John</strong>
                ...
                <div class="btn-group">
                    <div class="user-settings no-bg">
                        <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                            <img src="<?php echo base_url(); ?>plugins/img/admin.jpg" class="admin_img2 rounded-circle avatar-img" alt="avatar"> <strong><?php echo $this->session->userdata('firstName'); ?></strong>
                            <span class="fa fa-sort-down white_bg"></span>
                        </button>
                        <div class="dropdown-menu <?php echo $app_title; ?>_admin">
                            <a class="dropdown-item title" href="#">
                                <?php echo $app_title; ?></a>
                            ...
                            <a class="dropdown-item" href="lockscreen.html"><i class="fa fa-lock"></i>
                                Lock Screen</a> -->
                            <a class="dropdown-item" href="<?php echo base_url() ?>landing/logout"><i class="fa fa-sign-out"></i>
                                Log Out</a>
                        </div>
                    </div>
                </div>
...
<div id="left">
    <div class="media user-media bg-dark dker">
        ...
        <div class="user-wrapper bg-dark">
            <a class="user-link" href="">
                <img class="media-object img-thumbnail user-img rounded-circle admin_img3" alt="User Picture" src="<?php echo base_url(); ?>plugins/img/admin.jpg"><p class="text-white user-info">Welcome <?php echo $this->session->userdata('firstName'); ?></p></a>
    ...
    <ul id="menu" class="bg-blue dker">
        <li>
            <a href="<?php echo base_url(); ?>jururawat/dashboard">
                <i class="fa fa-home"></i>
                <span class="link-title">&nbsp;Dashboard</span>
            </a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>jururawat/senaraiPesakit">
                <i class="fa fa-user"></i>
                <span class="link-title">&nbsp;Senarai Pesakit</span>
            </a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>jururawat/pesakitBaharu">
                <i class="fa fa-plus"></i>
                <span class="link-title">&nbsp;Tambah Pesakit</span>
            </a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>jururawat/pesakitBaharu">
                <i class="fa fa-dollar-sign"></i>
                <span class="link-title">&nbsp;Paparan Kos Rawatan</span>
            </a>
        </li>


        <!-- <li>
          <a href="<?php echo base_url(); ?>doktor/">
        <li>
            <a href="javascript:;">
