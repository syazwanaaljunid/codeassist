...
<html>
  <head>
    ...
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>plugins/vendors/bootstrapvalidator/css/bootstrapValidator.min.css"/>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>plugins/vendors/wow/css/animate.css"/>
    <!--End of Plugin styles-->
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>plugins/css/pages/login.css"/>
                  ...
                  <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                      <div class="login_logo login_border_radius1">
                          <h3 class="text-center">
                              <img src="<?php echo base_url(); ?>plugins/img/logow.png" alt="josh logo" class="admire_logo" height=500 width="500"><span class="text-white"> <?php echo $app_title; ?> &nbsp;<br/>
                                  Log In</span>
                          </h3>
                      </div>
                      <div class="bg-white login_content login_border_radius">
                          <form action="<?php echo base_url(); ?>user/login" id="login_validator" method="post" class="login_validator">

                            <?php

                              if ($this->session->flashdata('error_login')) { ?>

                                <h4 style="color:red;"><?php echo $this->session->flashdata('error_login'); ?></h4>
...
<!--Plugin js-->
<script type="text/javascript" src="<?php echo base_url(); ?>plugins/vendors/bootstrapvalidator/js/bootstrapValidator.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>plugins/vendors/wow/js/wow.min.js"></script>
<!--End of plugin js-->
<script type="text/javascript" src="<?php echo base_url(); ?>plugins/js/pages/login.js"></script>

<!-- <script type="text/javascript">
  $(function() {

    $("#login_validator").submit(function(evt) {
        evt.preventDefault();
        var url = $(this).attr('action');
        var postData = $(this).serialize();

        $.post(url, postData, function(o) {}, 'json');
